...
const u8 gText_DexSearchTypeElectric[] = _("ELECTR");
...
const u8 gText_DexSortWeightDescription[] = _("Owned POKéMON are listed from the\nheaviest to the lightest.");
//const u8 gText_DexSortLightestDescription[] = _("Owned POKéMON are listed from the\nlightest to the heaviest.");
const u8 gText_DexSortHeightDescription[] = _("Owned POKéMON are listed from the\ntallest to the smallest.");
//const u8 gText_DexSortSmallestDescription[] = _("Owned POKéMON are listed from the\nsmallest to the tallest.");
const u8 gText_DexSortHPDescription[] = _("Owned POKéMON are listed from the\nhighest HP to the lowest.");
const u8 gText_DexSortAttackDescription[] = _("Owned POKéMON are listed from the\nhighest ATTACK to the lowest.");
const u8 gText_DexSortDefenseDescription[] = _("Owned POKéMON are listed from the\nhighest DEFENSE to the lowest.");
const u8 gText_DexSortSpAtkDescription[] = _("Owned POKéMON are listed from the\nhighest SP.ATK to the lowest.");
const u8 gText_DexSortSpDefDescription[] = _("Owned POKéMON are listed from the\nhighest SP.DEF to the lowest.");
const u8 gText_DexSortSpeedDescription[] = _("Owned POKéMON are listed from the\nhighest SPEED to the lowest.");
const u8 gText_DexSortStatsDescription[] = _("Owned POKéMON are listed from the\nhighest stats to the lowest.");
