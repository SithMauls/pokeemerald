...
const u8 gText_PokeNavCallsAll[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ALL{CLEAR_TO 0x2A}");
const u8 gText_PokeNavCallsRematch[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}REMATCH");
const u8 gText_PokeNavCallsNone[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}NONE{CLEAR_TO 0x2A}");
