...
const u8 gText_ListByType[] = _("Search by type.");
const u8 gText_ListByGroup[] = _("Search by group.");
const u8 gText_ListByAbility[] = _("Search by ability.");
const u8 gText_ListByMove[] = _("Search by move.");
const u8 gText_ListByMoveType[] = _("Search move by method of\nacquisition.");
...
const u8 gText_DexSortWeightTitle[] = _("WEIGHT MODE");
//const u8 gText_DexSortLightestTitle[] = _("LIGHTEST MODE");
const u8 gText_DexSortHeightTitle[] = _("HEIGHT MODE");
//const u8 gText_DexSortSmallestTitle[] = _("SMALLEST MODE");
const u8 gText_DexSortHPTitle[] = _("HP MODE");
const u8 gText_DexSortAttackTitle[] = _("ATTACK MODE");
const u8 gText_DexSortDefenseTitle[] = _("DEFENSE MODE");
const u8 gText_DexSortSpAtkTitle[] = _("SP.ATK MODE");
const u8 gText_DexSortSpDefTitle[] = _("SP.DEF MODE");
const u8 gText_DexSortSpeedTitle[] = _("SPEED MODE");
const u8 gText_DexSortStatsTitle[] = _("STATS MODE");
...
const u8 gText_DexSearchTypeBug[] = _("BUG");
const u8 gText_DexSearchTypeDark[] = _("DARK");
const u8 gText_DexSearchTypeDragon[] = _("DRAGON");
const u8 gText_DexSearchTypeElectric[] = _("ELECTRIC");
const u8 gText_DexSearchTypeFighting[] = _("FIGHT");
const u8 gText_DexSearchTypeFire[] = _("FIRE");
const u8 gText_DexSearchTypeFlying[] = _("FLYING");
const u8 gText_DexSearchTypeGhost[] = _("GHOST");
const u8 gText_DexSearchTypeGrass[] = _("GRASS");
const u8 gText_DexSearchTypeGround[] = _("GROUND");
const u8 gText_DexSearchTypeIce[] = _("ICE");
const u8 gText_DexSearchTypeNormalAE[] = _("NORMAL (A-E)");
const u8 gText_DexSearchTypeNormalFL[] = _("NORMAL (F-L)");
const u8 gText_DexSearchTypeNormalMR[] = _("NORMAL (M-R)");
const u8 gText_DexSearchTypeNormalS[] = _("NORMAL (S)");
const u8 gText_DexSearchTypeNormalTZ[] = _("NORMAL (T-Z)");
const u8 gText_DexSearchTypePoison[] = _("POISON");
const u8 gText_DexSearchTypePsychic[] = _("PSYCHIC");
const u8 gText_DexSearchTypeRock[] = _("ROCK");
const u8 gText_DexSearchTypeSteel[] = _("STEEL");
const u8 gText_DexSearchTypeWater[] = _("WATER");
...
const u8 gText_DexSearchGroupMonster[] = _("MONSTER");
const u8 gText_DexSearchGroupWater1[] = _("WATER 1");
const u8 gText_DexSearchGroupBug[] = _("BUG");
const u8 gText_DexSearchGroupFlying[] = _("FLYING");
const u8 gText_DexSearchGroupField[] = _("FIELD");
const u8 gText_DexSearchGroupFairy[] = _("FAIRY");
const u8 gText_DexSearchGroupGrass[] = _("GRASS");
const u8 gText_DexSearchGroupHumanLike[] = _("HUMAN-LIKE");
const u8 gText_DexSearchGroupWater3[] = _("WATER 3");
const u8 gText_DexSearchGroupMineral[] = _("MINERAL");
const u8 gText_DexSearchGroupAmorphous[] = _("AMORPHOUS");
const u8 gText_DexSearchGroupWater2[] = _("WATER 2");
const u8 gText_DexSearchGroupDitto[] = _("DITTO");
const u8 gText_DexSearchGroupDragon[] = _("DRAGON");
const u8 gText_DexSearchGroupUnknown[] = _("UNKNOWN");
...
const u8 gText_DexSortAtoZDescription[] = _("POKéMON are listed alphabetically.");
const u8 gText_DexSortWeightDescription[] = _("POKéMON are listed from the heaviest\nto the lightest.");
//const u8 gText_DexSortLightestDescription[] = _("Owned POKéMON are listed from the\nlightest to the heaviest.");
const u8 gText_DexSortHeightDescription[] = _("POKéMON are listed from the tallest\nto the smallest.");
//const u8 gText_DexSortSmallestDescription[] = _("Owned POKéMON are listed from the\nsmallest to the tallest.");
const u8 gText_DexSortHPDescription[] = _("POKéMON are listed from the highest\nHP to the lowest.");
const u8 gText_DexSortAttackDescription[] = _("POKéMON are listed from the highest\nATTACK to the lowest.");
const u8 gText_DexSortDefenseDescription[] = _("POKéMON are listed from the highest\nDEFENSE to the lowest.");
const u8 gText_DexSortSpAtkDescription[] = _("POKéMON are listed from the highest\nSP.ATK to the lowest.");
const u8 gText_DexSortSpDefDescription[] = _("POKéMON are listed from the highest\nSP.DEF to the lowest.");
const u8 gText_DexSortSpeedDescription[] = _("POKéMON are listed from the highest\nSPEED to the lowest.");
const u8 gText_DexSortStatsDescription[] = _("POKéMON are listed from the highest\nTOTAL stats to the lowest.");
...
const u8 gText_SelectMove[] = _("{SELECT_BUTTON} MOVE");
...
const u8 gText_PressAnyDpadKey[] = _("Press any {DPAD_NONE} key to\nregister the item\nin that slot.");
...
const u8 gText_StatsIVIncreased[] = _("{STR_VAR_1}'s {STR_VAR_2} IV was increased!");
const u8 gText_StatsIVDecreased[] = _("{STR_VAR_1}'s {STR_VAR_2} IV was decreased!");
const u8 gText_AllIVsMaxedOut[] = _("{STR_VAR_1}'s IVs were maxed out!");
...
const u8 gText_HyperTrainWhichStat[] = _("Hyper train which stat?");
...
const u8 gText_EffectChance[] = _("EFFECT %");
...
const u8 gText_PkmnStats[] = _("POKéMON STATS");
...
const u8 gText_Explain[] = _("EXPLAIN");
...
const u8 gText_TM32AndPrice[] = _("TM32{CLEAR_TO 0x48}1,000 COINS");
const u8 gText_TM29AndPrice[] = _("TM29{CLEAR_TO 0x48}2,000 COINS");
...
const u8 gText_RustedCap1BP[] = _("RUSTED CAP{CLEAR_TO 0x64}1BP");
const u8 gText_GoldCap5BP[] = _("GOLD CAP{CLEAR_TO 0x64}5BP");
...
const u8 gText_Leftovers12BP[] = _("LEFTOVERS{CLEAR_TO 0x5E}12BP");
const u8 gText_WhiteHerb12BP[] = _("WHITE HERB{CLEAR_TO 0x5E}12BP");
const u8 gText_QuickClaw12BP[] = _("QUICK CLAW{CLEAR_TO 0x5E}12BP");
const u8 gText_MentalHerb12BP[] = _("MENTAL HERB{CLEAR_TO 0x5E}12BP");
const u8 gText_BrightPowder16BP[] = _("BRIGHTPOWDER{CLEAR_TO 0x5E}16BP");
...
const u8 gText_FocusBand16BP[] = _("FOCUS BAND{CLEAR_TO 0x5E}16BP");
const u8 gText_ScopeLens16BP[] = _("SCOPE LENS{CLEAR_TO 0x5E}16BP");
const u8 gText_Softboiled4BP[] = _("SOFTBOILED{CLEAR_TO 0x54}4BP");
const u8 gText_SeismicToss6BP[] = _("SEISMIC TOSS{CLEAR_TO 0x54}6BP");
const u8 gText_DreamEater6BP[] = _("DREAM EATER{CLEAR_TO 0x54}6BP");
const u8 gText_MegaPunch6BP[] = _("MEGA PUNCH{CLEAR_TO 0x54}6BP");
...
const u8 gText_SwordsDance12BP[] = _("SWORDS DANCE{CLEAR_TO 0x4E}12BP");
const u8 gText_DefenseCurl4BP[] = _("DEFENSE CURL{CLEAR_TO 0x54}4BP");
const u8 gText_Snore6BP[] = _("SNORE{CLEAR_TO 0x54}6BP");
const u8 gText_MudSlap6BP[] = _("MUD-SLAP{CLEAR_TO 0x54}6BP");
const u8 gText_Swift6BP[] = _("SWIFT{CLEAR_TO 0x54}6BP");
const u8 gText_IcyWind6BP[] = _("ICY WIND{CLEAR_TO 0x54}6BP");
const u8 gText_Endure12BP[] = _("ENDURE{CLEAR_TO 0x4E}12BP");
const u8 gText_PsychUp12BP[] = _("PSYCH UP{CLEAR_TO 0x4E}12BP");
const u8 gText_IcePunch12BP[] = _("ICE PUNCH{CLEAR_TO 0x4E}12BP");
const u8 gText_ThunderPunch12BP[] = _("THUNDERPUNCH{CLEAR_TO 0x4E}12BP");
const u8 gText_FirePunch12BP[] = _("FIRE PUNCH{CLEAR_TO 0x4E}12BP");
...
const u8 gText_TrainerCardDex[] = _("DEX");
const u8 gText_TrainerCardLvl[] = _("LVL");
...
const u8 gText_SmallDot[] = _("{NAV_DOT_SMALL}");
const u8 gText_LargeDot[] = _("{NAV_DOT_LARGE}");
...
const u8 gText_PokeNavCalls[] = _("POKéNAV CALLS");
...
const u8 gText_FontRSE[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}R/S/E");
const u8 gText_FontFRLG[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}FR/LG");
const u8 gText_PokeNavCallsAll[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ALL");
const u8 gText_PokeNavCallsBattle[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}BATTLE");
const u8 gText_PokeNavCallsNone[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}NONE");
...
const u8 gText_GoldCap[] = _("GOLD CAP");
const u8 gText_RustedCap[] = _("RUSTED CAP");
