...
const u32 gSummaryPage_Stats_Tilemap[]       = INCBIN_U32("graphics/summary_screen/page_stats.bin.lz");
...
const u32 gPokedexMenuShort_Gfx[] = INCBIN_U32("graphics/pokedex/menu_short.4bpp.lz");
...
const u32 gPokedexMovesUnderlay_Tilemap[] = INCBIN_U32("graphics/pokedex/moves_underlay.bin.lz");
