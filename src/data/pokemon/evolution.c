...
const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_POLIWHIRL]  = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_POLIWRATH},
                            {EVO_ITEM_ITEM, ITEM_KINGS_ROCK, SPECIES_POLITOED},
    ...
    [SPECIES_SLOWPOKE]   = {{EVO_LEVEL, 37, SPECIES_SLOWBRO},
                            {EVO_ITEM_ITEM, ITEM_KINGS_ROCK, SPECIES_SLOWKING},
    ...
    [SPECIES_ONIX]       = {{EVO_ITEM_ITEM, ITEM_METAL_COAT, SPECIES_STEELIX},
    ...
    [SPECIES_SEADRA]     = {{EVO_ITEM_ITEM, ITEM_DRAGON_SCALE, SPECIES_KINGDRA},
    ...
    [SPECIES_SCYTHER]    = {{EVO_ITEM_ITEM, ITEM_METAL_COAT, SPECIES_SCIZOR},
    ...
    [SPECIES_PORYGON]    = {{EVO_ITEM_ITEM, ITEM_UP_GRADE, SPECIES_PORYGON2},
    ...
    [SPECIES_CLAMPERL]   = {{EVO_ITEM_ITEM, ITEM_DEEP_SEA_TOOTH, SPECIES_HUNTAIL},
                            {EVO_ITEM_ITEM, ITEM_DEEP_SEA_SCALE, SPECIES_GOREBYSS},
