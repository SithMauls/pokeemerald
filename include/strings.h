...
extern const u8 gText_PokeNavCallsBattle[];
...
extern const u8 gText_SelectMove[];
...
extern const u8 gText_StatsIVDecreased[];
extern const u8 gText_AllIVsMaxedOut[];
...
extern const u8 gText_GoldCap5BP[];
...
extern const u8 gText_Leftovers12BP[];
extern const u8 gText_WhiteHerb12BP[];
extern const u8 gText_QuickClaw12BP[];
extern const u8 gText_MentalHerb12BP[];
extern const u8 gText_BrightPowder16BP[];
extern const u8 gText_ChoiceBand16BP[];
extern const u8 gText_KingsRock16BP[];
extern const u8 gText_FocusBand16BP[];
...
extern const u8 gText_Softboiled4BP[];
extern const u8 gText_SeismicToss6BP[];
extern const u8 gText_DreamEater6BP[];
extern const u8 gText_MegaPunch6BP[];
...
extern const u8 gText_SwordsDance12BP[];
extern const u8 gText_DefenseCurl4BP[];
extern const u8 gText_Snore6BP[];
extern const u8 gText_MudSlap6BP[];
extern const u8 gText_Swift6BP[];
extern const u8 gText_IcyWind6BP[];
extern const u8 gText_Endure12BP[];
extern const u8 gText_PsychUp12BP[];
extern const u8 gText_IcePunch12BP[];
extern const u8 gText_ThunderPunch12BP[];
extern const u8 gText_FirePunch12BP[];
...
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_GoldCapDesc[];
...
extern const u8 gText_EffectChance[];
...
extern const u8 gText_ListByMoveType[];
...
extern const u8 gText_DexSortWeightTitle[];
//extern const u8 gText_DexSortLightestTitle[];
extern const u8 gText_DexSortHeightTitle[];
//extern const u8 gText_DexSortSmallestTitle[];
extern const u8 gText_DexSortHPTitle[];
extern const u8 gText_DexSortAttackTitle[];
extern const u8 gText_DexSortDefenseTitle[];
extern const u8 gText_DexSortSpAtkTitle[];
extern const u8 gText_DexSortSpDefTitle[];
extern const u8 gText_DexSortSpeedTitle[];
extern const u8 gText_DexSortStatsTitle[];
...
extern const u8 gText_DexSearchTypeBug[];
extern const u8 gText_DexSearchTypeDark[];
extern const u8 gText_DexSearchTypeDragon[];
extern const u8 gText_DexSearchTypeElectric[];
extern const u8 gText_DexSearchTypeFighting[];
extern const u8 gText_DexSearchTypeFire[];
extern const u8 gText_DexSearchTypeFlying[];
extern const u8 gText_DexSearchTypeGhost[];
extern const u8 gText_DexSearchTypeGrass[];
extern const u8 gText_DexSearchTypeGround[];
extern const u8 gText_DexSearchTypeIce[];
extern const u8 gText_DexSearchTypeNormalAE[];
extern const u8 gText_DexSearchTypeNormalFL[];
extern const u8 gText_DexSearchTypeNormalMR[];
extern const u8 gText_DexSearchTypeNormalS[];
extern const u8 gText_DexSearchTypeNormalTZ[];
extern const u8 gText_DexSearchTypePoison[];
extern const u8 gText_DexSearchTypePsychic[];
extern const u8 gText_DexSearchTypeRock[];
extern const u8 gText_DexSearchTypeSteel[];
extern const u8 gText_DexSearchTypeWater[];
...
extern const u8 gText_DexSearchGroupMonster[];
extern const u8 gText_DexSearchGroupWater1[];
extern const u8 gText_DexSearchGroupBug[];
extern const u8 gText_DexSearchGroupFlying[];
extern const u8 gText_DexSearchGroupField[];
extern const u8 gText_DexSearchGroupFairy[];
extern const u8 gText_DexSearchGroupGrass[];
extern const u8 gText_DexSearchGroupHumanLike[];
extern const u8 gText_DexSearchGroupWater3[];
extern const u8 gText_DexSearchGroupMineral[];
extern const u8 gText_DexSearchGroupAmorphous[];
extern const u8 gText_DexSearchGroupWater2[];
extern const u8 gText_DexSearchGroupDitto[];
extern const u8 gText_DexSearchGroupDragon[];
extern const u8 gText_DexSearchGroupUnknown[];
...
extern const u8 gText_DexSortWeightDescription[];
//extern const u8 gText_DexSortLightestDescription[];
extern const u8 gText_DexSortHeightDescription[];
//extern const u8 gText_DexSortSmallestDescription[];
extern const u8 gText_DexSortHPDescription[];
extern const u8 gText_DexSortAttackDescription[];
extern const u8 gText_DexSortDefenseDescription[];
extern const u8 gText_DexSortSpAtkDescription[];
extern const u8 gText_DexSortSpDefDescription[];
extern const u8 gText_DexSortSpeedDescription[];
extern const u8 gText_DexSortStatsDescription[];
...
extern const u8 gText_RustedCap[];
extern const u8 gText_GoldCap[];
...
extern const u8 gText_HyperTrainWhichStat[];
...
extern const u8 gText_TrainerCardDex[];
extern const u8 gText_TrainerCardLvl[];
